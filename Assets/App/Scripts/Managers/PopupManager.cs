...
public class PopupManager : SingletonComponent<PopupManager>
{
	...
	public void Show(string id, object[] inData, Popup.PopupClosed popupClosed)
	{
		...
		if (popup != null)
		{
			...
			{
				//EDIT TO PUT ACTIVE POPUP ALWAYS ON TOP
				popup.GetComponent<Transform>().SetAsLastSibling();
				//END EDIT
	...
	public bool ForceCloseActivePopup()
    {
		if (activePopups.Count > 0)
		{
			int index = activePopups.Count - 1;
	...
	public void ForceCloseAllActivePopup()
	{
